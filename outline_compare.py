...
CAPTURE = "live_capture.npy"
FIRMWARE = "cat_outline.py"
...
def expected_volts():
    ...
    return ((dense.reshape(-1, 2) / 255.0) * 3.3)
...
def draw(trace, want, path="outline_compare.png"):
    import matplotlib
    matplotlib.use("Agg")
    import matplotlib.pyplot as plt
    panels = (("Sent to the PWM pins", want, "#e8e0c8"),
              ("Read back through the ADC", trace, "#39ff5a"))
    fig, axes = plt.subplots(1, 2, figsize=(10, 5.4), facecolor="black")
